...
<body>
    ...
    {{-- <script src="https://cdn.tiny.cloud/1/wo91jq4iw7p6wjrv6cwupqa3kzins2ptisglnivme51s43nd/tinymce/5.10.3/tinymce.min.js" referrerpolicy="origin"></script> --}}
    ...
    <script>
        jQuery(document).ready(function($) {
            "use strict";
            $('.checkbox_header').on('click',function(){
                $(this).parents('.cards').find('.checkbox_body').prop('checked',$(this).prop('checked'));
                // $(this).parents().find('.checkbox_body').prop('checked',$(this).prop('checked'));
            })
            $('.checkbox_all').on('click',function(){
                $(this).parents().find('.checkbox_header').prop('checked',$(this).prop('checked'));
                $(this).parents().find('.checkbox_body').prop('checked',$(this).prop('checked'));
            })
            ...
            $(".choose_roles").select2({
                tags: true,
                tokenSeparators: [','],
                'placeholder': 'Select Role'
            })
            $(".categry_select").select2({
