                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="{{route('category.update', $cate->id)}}" method="post" class="">
                                @csrf
                                {{-- @method("PUT") --}}
                                <div class="form-group">
                                    <label for="name"
                                        ...
                                        name="name" value="{{$cate->name}}" placeholder="Enter Name.." class="form-control">
                                        {{-- <span
                                ...
                                <div class="form-group">
                                    <label for="name"
                                        ...
                                        <select name="parent_id" id="parent_id" class="form-control">
                                            ...
                                            <option value="{{$key}}" {{($cate->parent_id==$key)?' selected':''}}>{{$value}}</option>
                                            <?php
                                            if($key!=0){
