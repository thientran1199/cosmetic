    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5><label for="">ID: &nbsp;</label>{{$item->id}}</h5>
                <h5><label for="">OrderID: &nbsp;</label>{{$item->orders->id}}</h5>
                <h5><label for="">Product: &nbsp;</label>{{$item->products->name}}</h5>
                <h5><label for="">Quantity: &nbsp;</label>{{$item->quantity}}</h5>
                <h5><label for="">Price: &nbsp;</label>{{number_format($item->price)}}</h5>
                {{-- <h5><label for="">Product: &nbsp;</label>{{$item->products->name}}</h5> --}}
