...
<body>
   <div id="container">
       ...
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1278 1080">
         ...
         <div id="details">
           <ul>
             <li><span>NOTIFICATION</span><span>NO RIGHT</span></li>
             <li><span>DATE   <br>       TIME</span><span id="current_date"></span></li>
             <li><span>ACTION</span><span>
                 <a href="#" style="text-decoration: none; color:rgb(83, 133, 145)">Go Back</a></span></li>
           </ul>
...
<script>
   ...
   s = date.getSeconds();
   document.getElementById("current_date").innerHTML =  day + "/" + month + "/" + year + "<br>" + hours + ":"+ minute+ ":"+ s;
   </script>
</html>
