<div class="footer">
                ...
                <ul class="footer__list">
                    <li class="footer__item">
                        <span class="footer__text">
                                <i class="fas fa-map-marked-alt"></i> TP.Huế, Thừa - Thiên Huế
                            </span>
                    </li>
                    <li class="footer__item">
                        <a href="#" class="footer__link">
                            <i class="fas fa-phone"></i> 077 527 5597
                        </a>
                    </li>
                    <li class="footer__item">
                        <a href="#" class="footer__link">
                            <i class="fas fa-envelope"></i> thientran99.it@gmail.com
                        </a>
                    </li>
                    <li class="footer__item">
    ...
    <div class="copyright">
        <span class="footer__text"> &copy Bản quyền thuộc về <a class="footer__link" href="#"> Thiện Trần</a></span>
    </div>
</div>