                ...
                <div class="row">
                    <div class="col l-5 m-12 s-12">
                        <div class="owl-carousel owl-theme" id="sync1">
                            <a href="#" class="product">
                                <div class="product__avt" style="background-image: url({{asset($pd->feature_image_path)}})">
                                </div>
                            </a>
                            @foreach ($pd->images as $item)
                            <a href="#" class="product">
                                <div class="product__avt" style="background-image: url({{asset($item->image_path)}})">
                                </div>
                            </a>
                            @endforeach
                        </div>
                    ...
                    <div class="col l-7 m-12s s-12 pl">
                        <div class="main__breadcrumb">
                            ...
                            <div class="breadcrumb__item">
                                <a href="#" class="breadcrumb__link">Hãng {{$pd->category->name}}</a>
                            </div>
                        </div>
                        ...
                        <div class="productInfo__price">
                            @if ($pd->promotion_price == null)
                            {{number_format($pd->price)}} <span class="priceInfo__unit">đ</span>
                            @else
                            {{number_format($pd->promotion_price)}} <span class="priceInfo__unit">đ</span>
                            
                            @endif
                            
                        </div>
                        <div class="productInfo__description">
                            <span> {{$pd->name}}</span>  {!!$pd->content!!}
                        </div>

                        <div class="productInfo__addToCart">
                            <div class="buttons_added">
                                {{-- <input class="minus is-form" type="button" value="-" onclick="minusProduct()">
                                <input aria-label="quantity" class="input-qty" max="10" min="1" name="quantity[]" id="quantity"  type="number" value="1">
                                <input class="plus is-form" type="button" value="+" onclick="plusProduct()"> --}}
                            </div>
                            
                            {{-- <a href="{{ route('cart.add',['id'=>$pd->id]) }}" class="btn"><div class=" btn btn--default orange ">Thêm vào giỏ</div></a> --}}
                                <a href="#" onclick="addCart({{$pd->id}})"  class="btn"><div class=" btn btn--default orange ">Thêm vào giỏ</div></a>
                        </div>
                        <div class="productIndfo__policy ">
                            <div class="policy bg-1 ">
                                <img src="{{asset('frontend/assets/img/policy/policy1.png') }} " class="productIndfo__policy-img "></img>
                            ...
                            <div class="policy bg-2 ">
                                <img src="{{asset('frontend/assets/img/policy/policy2.png') }} " class="productIndfo__policy-img "></img>
                                <div class="productIndfo__policy-info ">
                                    <h3 class="productIndfo__policy-title ">Giao hàng miễn phí</h3>
                                    <p class="productIndfo__policy-description ">Cho đơn hàng từ 300K</p>
                                </div>
                            ...
                            <div class="policy bg-1 ">
                                <img src="{{asset('frontend/assets/img/policy/policy3.png') }} " class="productIndfo__policy-img "></img>
                                <div class="productIndfo__policy-info ">
                                    <h3 class="productIndfo__policy-title ">Giao hàng miễn phí</h3>
                                    <p class="productIndfo__policy-description ">Cho đơn hàng từ 300K</p>
                                </div>
                            ...
                            <div class="policy bg-2 ">
                                <img src="{{asset('frontend/assets/img/policy/policy4.png') }} " class="productIndfo__policy-img "></img>
                                <div class="productIndfo__policy-info ">
                                    <h3 class="productIndfo__policy-title ">Giao hàng miễn phí</h3>
                                    <p class="productIndfo__policy-description ">Cho đơn hàng từ 300K</p>
                                </div>
                        ...
                        <div class="productIndfo__category ">
                            ...
                            <p class="productIndfo__category-text"> Hãng : <a href="# " class="productIndfo__category-link ">{{$pd->category->name}}</a></p>
                            <p class="productIndfo__category-text"> Số lượng đã bán : 322</p>
                            <p class="productIndfo__category-text"> Số lượng trong kho : {{$pd->quantity}}</p>
            ...
            <div class="main__frame ">
                <div class="grid wide ">
                    ...
                    <div class="owl-carousel hight owl-theme ">
                        ...
                        <a href="{{route('product.detail',['id'=>$item->id])}} " class="product ">
                            ...
                            <div class="product__info ">
                                ...
                                <div class="product__price ">
                                    ...
                                    <div class="price__old ">{{number_format($item->promotion_price)}} <span class="price__unit ">đ</span></div>
...
<script src="{{asset('frontend/assets/js/cart.js')}}"></script>
    <!-- Script common -->
    <script src="{{asset('frontend/assets/js/commonscript.js') }} ">
    </script>
    <script>
        function calcRate(r) {
